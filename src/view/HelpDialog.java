...
public class HelpDialog  extends JDialog{
	...
	public HelpDialog(Frame owner, String title, boolean modal) {
		...
		String RS ="<html>Pomoć: <br/>"
				...
				+ "Adresa se mora uneti u formatu : ulica,broj,grad,država <br/>"
				+ "Za telefon nema ograničenja <br/>"
				+ "Za broj lične karte mora tačno 9 brojeva <br/>"
				+ "Za godine staža mora broj <br/>"
				+ "EMail adrese mora sadržati niz karaktera, pa tačku, pa niz karaktera pa @, pa niz karaktera pa tačku pa opet niz karaktera <br/>"
				+ " <br/>"
				+ "Predaje --- <br/>"
				...
				+ "ALT + D : Pozicionira se na meni stavku za pomoć <br/>"
				+ "ALT + B : Pozicionira se na meni stavku za pomoć <br/>"
				+ " <br/>"
				+ "---------------------------------------------------------------------------------------------------------------------------------- <br/>"
				+ " <br/>"
				+ "Akceleratori: <br/>"
				...
				+ "CTRL + I : Prikaz pomoći <br/>"
				+ "CTRL + X : Prikaz infromacija o aplikaciji </html>";
